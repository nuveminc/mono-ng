export const orders = [
  {
        ...
        traceHistory: [
          {
            ...
            documents: null,
            dtCreated: '2022-04-10T12:43:33.432',
          },
        ],
      },
    ],
      ...
      release: [
        {
          ...
          notes:
            'Each section indicated will be included in Block 12 of the ARC separately in block format. A space shall probe provided between each section to allow separation of information reported. In the event the information cannot be contained within Block 12, then a separate sheet, or continuation sheet shall be utilized. Completion of Block 12 in this format constitutes compliance with the intent of FAR 43.9 and the FAR 121 maintenance program.  This format is subject to change as internal requirements dictate',
        },
      ],
      serviceReport: [],
      quoteInstruction: [],
    ...
    workflow: [
      ...
      },
      {
        ...
        dtViewed: false,
        dtEstimatedComplete: null,
        dtCompleted: '2022-04-13T16:07:09.052',
        performance: 'EARLY',
        status: 'COMPLETE',
        statusLog: [
          {
        ...
        documents: [
          {
            ...
            dtUploaded: '2022-04-13T16:07:09.047',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        dtCompleted: '2022-04-13T16:07:41.595',
        performance: 'EARLY',
        status: 'COMPLETE',
        statusLog: [
          {
            state: 'COMPLETED',
            createdBy: 'Luca Mellor',
            dtCreated: '2022-04-13T16:07:41.595',
          },
        ],
        documents: [
          {
    ...
    errors: [
      {
        ...
        description:
          'All EO’s and FCD’s by number, revision level, and date exactly as on the S/O must be noted as “Has Been Complied with”, “Has Previously Complied With”, and when/how determined, “Not Applicable” and why, or “Not Complied with” and why.',
        submittedBy: 'David Bettenhausen',
        dtCreated: '2022-04-24T22:49:18.482Z',
      },
    ],
    dataCorrectionRequest: null,
    reasonOnHold: null,
    dtEvaluationCompleted: null,
    remarks: [
      'If there are attachments to the 8130, reference them by ARC form tracking number, and the Service Order number, and date.',
    ],
    quote: [
      {
        status: 'SUBMITTED',
